...
<body>
  ...
  <section class="page-section bg-light">
            ...
            <form action="/transaksi/update/{{$transaksi->id}}" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" class="form-control" name="nama_pembeli" value="{{$transaksi->nama_pembeli}}">
                <input type="hidden" class="form-control" name="no_telepon_pembeli" value="{{$transaksi->no_telepon_pembeli}}">
                <input type="hidden" class="form-control" name="jumlah_beli" value="{{$transaksi->jumlah_beli}}">
                <br/>
