  ...
  <div class="col mb-4">
    ...
    <img src="{{asset('storage/'.$barang->gambar)}}" class="card-img-top" alt="...">
        ...
        {{ $barang->keterangan}}
          ...
          <br></br>
          <a href="/kid/bajupanjang/transaksi/{{$barang->id}}" class="btn btn-primary"><i class="fas fa-shopping-cart"></i> beli</a>
      </div>
    </div>
  </div>
  @endforeach
  &nbsp;&nbsp;&nbsp;<h5><a href="/komen11" class="btn btn-primary"> Komentar</a>
   <br>
   <br>
  </div>
  </div>
