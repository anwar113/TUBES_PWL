      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          ...
          <div class="card-body">
            ...
            <h3><a href="sale/edit/{{ $m->id }}" class="badge badge-success">Beli</a></h3>
          </div>
        </div>
      </div>
      @endforeach
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          ...
          <div class="card-body">
            ...
            <h3><a href="sale/edit/{{ $w->id }}" class="badge badge-success">Beli</a></h3>
          </div>
        </div>
      </div>
      @endforeach
      ...
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="card h-100">
          ...
          <div class="card-body">
            ...
            <h3><a href="sale/edit/{{ $k->id }}" class="badge badge-success">Beli</a></h3>
          </div>
        </div>
      </div>
      @endforeach
